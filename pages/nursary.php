...
<!-- Main Content -->
  <div class="main-content">
    <h1>Class Nursary's Students</h1>
    <p>Below is the list of students in Class Nursary.</p>
      ...
      <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
          <?php
            ...
            $query_students = "SELECT * FROM students WHERE class = 'nursary'";
            ...
            if (mysqli_num_rows($result_students) > 0) {
                ...
                echo "<tr><td colspan='6'>No students found for Class Nursary.</td></tr>";
            }
