...
<!-- Main Content -->
  <div class="main-content">
    ...
    <p>Below is the list of students in Class One.</p>
      ...
      <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
          <?php
            ...
            $query_students = "SELECT * FROM students WHERE class = 'one'";
            ...
            if (mysqli_num_rows($result_students) > 0) {
                ...
                echo "<tr><td colspan='6'>No students found for Class 1.</td></tr>";
            }
