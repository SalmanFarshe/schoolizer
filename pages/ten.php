...
<!-- Main Content -->
  <div class="main-content">
    <h1>Class Ten Students</h1>
    <p>Below is the list of students in Class Ten.</p>
    ...
    <div class="table-responsive mx-auto">
      <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
          <?php
            // Fetch students from class ten
            $query_students = "SELECT * FROM students WHERE class = 'ten'";
            $result_students = mysqli_query($connection, $query_students);

            // Check if there are students in class ten
            if (mysqli_num_rows($result_students) > 0) {
                ...
                echo "<tr><td colspan='6'>No students found for Class 10.</td></tr>";
            }
