...
<!-- Main Content -->
  <div class="main-content">
    <h1>Class Four Students</h1>
    <p>Below is the list of students in Class Four.</p>
      ...
      <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
          <?php
            ...
            $query_students = "SELECT * FROM students WHERE class = 'four'";
            ...
            if (mysqli_num_rows($result_students) > 0) {
                ...
                echo "<tr><td colspan='6'>No students found for Class 4.</td></tr>";
            }
