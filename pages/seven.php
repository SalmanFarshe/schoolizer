...
<!-- Main Content -->
  <div class="main-content">
    <h1>Class Seven Students</h1>
    <p>Below is the list of students in Class Seven.</p>
    ...
    <div class="table-responsive mx-auto">
      <table class="table table-striped table-bordered text-center">
        ...
        <tbody>
          <?php
            // Fetch students from class seven
            $query_students = "SELECT * FROM students WHERE class = 'seven'";
            $result_students = mysqli_query($connection, $query_students);

            // Check if there are students in class seven
            if (mysqli_num_rows($result_students) > 0) {
                ...
                echo "<tr><td colspan='6'>No students found for Class 7.</td></tr>";
            }
